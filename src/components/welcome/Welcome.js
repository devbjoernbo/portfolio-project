...
const ShowSecondPage = () => (
	<StyledDecriptionContainer>
		...
		<StyledDecription>
			...
			rapporten og jeg stod for programmeringen af programmet.
		</StyledDecription>
		<StyledDecription>
		...
		<StyledDecription>
			Jeg startede processen med små kurser i HTML, CSS og JavaScript, som
			...
			begyndte jeg på at lære ReactJS, som udgør den stack jeg programmere
...
const ShowFirstPage = () => (
	<StyledDecriptionContainer>
		...
		<StyledDecription>
			...
			softwareudvikler. Jeg har et mål om, at blive den bedste programmør,
			jeg kan blive. Dette forudsætter, at jeg hele tiden fokusere på at
			lære nye og mere effektive måder, at gøre tingene på.
		</StyledDecription>
		<StyledDecription>
			...
			blive bedre til at udvikle løsninger, der relatere sig til begge af
			områderne - og jeg er selvfølgelig villig til at yde den indsats,
			der kræves, for, at jeg udvikler mine kompetencer, samt skaber
			størst mulig værdi, der, hvor min fremtidige arbejdsgiver mener, at
			de har brug for min arbejdskraft.
		</StyledDecription>
		<StyledDecription>
			Denne hjemmeside er programmeret med Node, Express. og React. Jeg
			har opsat hjemmesiden på Heroku med DNS-administration på One.com.
			CSS'en har jeg implementeret med Styled-Components, og brugt
			react-spring og react-transition-group til animationen. Jeg vil
